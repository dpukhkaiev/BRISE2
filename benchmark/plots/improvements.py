...
def improvements(experiments):
    ...
    layout = dict(title="Relatively improvements result", yaxis=dict(zeroline=False, title="Result"), xaxis=dict(zeroline=False, title="Iteration"), legend=dict(yanchor="top", font=dict(size=10)))
