...
3. `spark()` method (in ./worker/worker.py) - worker method, that measures Spark task with concrete parameters
...
2. add workers' public key to the list of spark service's *authorized_keys*
3. add spark_service to the list of worker's *known_hosts*
