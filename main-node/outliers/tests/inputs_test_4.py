...
def get_inputs_for_outliers_test(results_init, outlier_criterions_init, result_structure_init):
    # if we add 1 outlier and several bad values
    ...
    results = [{'result': {'energy': 100223.3292}, 'worker': 'alpha', 'task id': 'e699ce2aaad443f88f258ae543262ea2', 'ResultValidityCheckMark': 'OK'}, 
    {'result': {'energy': 'Bad value'}, 'worker': 'alpha', 'task id': '19e1bb7007854fc1a6a827cab28ede3f', 'ResultValidityCheckMark': 'Bad value'}, 
    {'result': {'energy': 'Bad value'}, 'worker': 'alpha', 'task id': '715f2e8628374a2d8cbf794bbafb1261', 'ResultValidityCheckMark': 'Bad value'}, 
    {'result': {'energy': 'Bad value'}, 'worker': 'alpha', 'task id': '9ce08308fbff411cb7cc1655ad43effe', 'ResultValidityCheckMark': 'Bad value'}, 
