...
from core_entities.search_space import NominalHyperparameter, OrdinalHyperparameter
from core_entities.search_space import IntegerHyperparameter, FloatHyperparameter
...
def build_preprocessing_pipelines(parameters: Mapping, data_description: Mapping) -> [Pipeline, Pipeline]:
    ...
    # TODO: labels pipeline should be built
