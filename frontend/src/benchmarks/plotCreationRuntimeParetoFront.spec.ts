...
import { ParetoFront } from "../widgets/charts/pareto-front/index"
...
describe("Pareto Front - Plot Creation Runtime Benchmark", () => {
    ...
    it("measures plot creation runtime for different numbers of trials", async () => {
            ...
            for (let run = 0; run < repetitions; run++) {
                ...
                const wrapper =
                    mount(ParetoFront, {
                        ...
                        props: {
                            paretoObjective1: "objective1",
                            paretoObjective2: "objective2",
        ...
        await writeFile(
            "./results/paretoFront-plotCreation-trials.csv",
            csv
        )
    }, 600_000)
    ...
    it("measures plot creation runtime for different numbers of params", async () => {
        ...
        await writeFile(
            "./results/paretoFront-plotCreation-params.csv",
            csv
        )
    }, 600_000)
    ...
    it("measures plot creation runtime for different numbers of objectives", async () => {
        ...
        await writeFile(
            "./results/paretoFront-plotCreation-objectives.csv",
            csv
        )
    }, 600_000)
})