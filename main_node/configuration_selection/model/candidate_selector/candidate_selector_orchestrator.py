...
class CandidateSelectorOrchestrator:
    ...
    def get_candidate_selector(self, candidate_selector_description: Dict) -> CandidateSelector:
        ...
        assert len(keys) == 1
        feature_name = keys[0]
        candidate_selector_class = reflective_class_import(class_name=candidate_selector_description[feature_name]["Type"], folder_path="configuration_selection/model/candidate_selector")
