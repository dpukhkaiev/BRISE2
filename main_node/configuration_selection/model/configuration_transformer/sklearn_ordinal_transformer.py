...
from configuration_selection.model.configuration_transformer.ordinal_transformer_abs import OrdinalTransformer
...
class SklearnOrdinalTransformer(OrdinalTransformer):
