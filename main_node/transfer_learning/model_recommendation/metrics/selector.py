...
def get_metric(experiment_description: dict, is_mimimization: bool):
    """
    Construct instance of metric according to the experiment description.
    """
    logger = logging.getLogger(__name__)
    metric = experiment_description["TransferLearning"][
        "ModelsRecommendation"]["DynamicModelsRecommendation"]["PerformanceMetric"]
