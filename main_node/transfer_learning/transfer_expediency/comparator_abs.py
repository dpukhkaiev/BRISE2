...
class Comparator(ABC):
    def __init__(self, experiment_description: dict, experiment_id: str):
        ...
        self.minNumberOfSamples = self.experiment_description["TransferLearning"]["TransferExpediencyDetermination"]["MinNumberOfSamples"]
    ...
    def get_similar_experiments(self, source_experiments: list):
        ...
        for source_experiment in source_experiments:
            ...
            if len(target_labels) >= self.minNumberOfSamples:
    ...
    @abstractmethod
    def get_source_and_target_labels(self, model): pass

    @abstractmethod
    def compute_metric(self, source_labels: list, target_labels: list): pass
