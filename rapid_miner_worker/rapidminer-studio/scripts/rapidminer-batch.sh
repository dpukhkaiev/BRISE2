...
############################################################
##                                                        ##
##     Unix Start Script for RapidMiner Studio (Batch)    ##
##                                                        ##
...
##################################
##                              ##
##  Generate JVM start options  ##
##                              ##
##################################

rmClasspath="${RAPIDMINER_HOME}"/lib/*:"${RAPIDMINER_HOME}"/lib/jdbc/*
JVM_OPTIONS=$($JAVA -cp "${rmClasspath}" com.rapidminer.launcher.JVMOptionBuilder "$@")
...
do
    ...
    eval $JAVA $JVM_OPTIONS -cp \"${rmClasspath}\" com.rapidminer.launcher.CommandLineLauncher "$@"
